...
enat.listOfDicts = [
    { id: 'philosophy', title: 'Philosophy', count: 4, style: 'background-color: #19F;', color: '#19F', disabled: false },
    { id: 'test2', title: 'Linguistics', count: 0, style: 'background-color: #1E6;', color: '#1E6', disabled: true },
